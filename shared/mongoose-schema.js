...
// // 🔥 Auto-increment generatedId (E1, E2, E3...)
// profileSchema.pre("save", async function (next) {
//   if (this.generatedId) return next();

//   try {
//     const lastProfile = await this.constructor.findOne({}, {}, { sort: { createdAt: -1 } });
...
profileSchema.pre("save", async function (next) {
  ...
  try {
    ...
    this.generatedId = `E${String(nextNumber).padStart(2, "0")}`; // E01, E02, etc.
    next();
  } catch (err) {
    next(err);
  }
